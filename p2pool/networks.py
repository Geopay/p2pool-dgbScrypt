...
nets = dict(
    digibyteScrypt=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=8023,
        BOOTSTRAP_ADDRS='p2p.mine.bz pool2eu.dgbmining.com dgbpool.cloudapp.net pool2na.dgbmining.com pool2me.dgbmining.com p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dtdns.net solidpool.org taken.pl birdspool.no-ip.org'.split(' '),
